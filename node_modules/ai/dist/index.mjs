...
var _a4;
var MCPClientError = class extends AISDKError4 {
  constructor({
...
var _a7;
var NoOutputSpecifiedError = class extends AISDKError7 {
  // used in isInstance
...
var _a10;
var InvalidDataContentError = class extends AISDKError10 {
  constructor({
    content,
    cause,
...
var _a11;
var InvalidMessageRoleError = class extends AISDKError11 {
  constructor({
    role,
...
var _a12;
var MessageConversionError = class extends AISDKError12 {
  constructor({
    originalMessage,
    message
  }) {
...
var _a13;
var DownloadError = class extends AISDKError13 {
  constructor({
    url,
    statusCode,
    statusText,
...
import { delay, getErrorMessage as getErrorMessage5, isAbortError } from "@ai-sdk/provider-utils";
...
// core/types/provider-metadata.ts
var providerMetadataSchema = z4.record(
  z4.string(),
  z4.record(z4.string(), jsonValueSchema)
);
...
var outputSchema = z5.discriminatedUnion("type", [
  z5.object({
    type: z5.literal("text"),
    value: z5.string()
  }),
  ...
  z5.object({
    type: z5.literal("error-text"),
    value: z5.string()
  }),
  z5.object({
    type: z5.literal("error-json"),
    value: jsonValueSchema
  }),
  z5.object({
      ...
      switch (toolType) {
        ...
        case "function":
          return {
            ...
            inputSchema: asSchema2(tool3.inputSchema).jsonSchema
          };
