...
var _a4;
var MCPClientError = class extends import_provider4.AISDKError {
  constructor({
...
var _a7;
var NoOutputSpecifiedError = class extends import_provider7.AISDKError {
  // used in isInstance
...
var _a10;
var InvalidDataContentError = class extends import_provider10.AISDKError {
  constructor({
    content,
    cause,
...
var _a11;
var InvalidMessageRoleError = class extends import_provider11.AISDKError {
  constructor({
    role,
...
var _a13;
var DownloadError = class extends import_provider13.AISDKError {
  constructor({
    url,
    statusCode,
    statusText,
...
// core/prompt/create-tool-model-output.ts
...
function createToolModelOutput({
  ...
  if (errorMode === "text") {
    return { type: "error-text", value: (0, import_provider16.getErrorMessage)(output) };
...
function createUIMessageStream({
  execute,
  onError = import_provider_utils6.getErrorMessage,
  originalMessages,
  onFinish,
...
function simulateReadableStream({
  ...
  var _a16;
  const delay2 = (_a16 = _internal == null ? void 0 : _internal.delay) != null ? _a16 : import_provider_utils7.delay;
  let index = 0;
      ...
      switch (toolType) {
        ...
        case "function":
          return {
            ...
            inputSchema: (0, import_provider_utils17.asSchema)(tool3.inputSchema).jsonSchema
          };
...
async function doParseToolCall({
  ...
  const schema = (0, import_provider_utils18.asSchema)(tool3.inputSchema);
  ...
  async tools({
    ...
    try {
      ...
      for (const { name: name16, description, inputSchema } of listToolsResult.tools) {
        ...
        const self = this;
        const toolWithExecute = (0, import_provider_utils26.tool)({
          description,
