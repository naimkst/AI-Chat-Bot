...
var ClientOrServerImplementationSchema = import_v4.z.object({
  name: import_v4.z.string(),
  version: import_v4.z.string()
}).passthrough();
var BaseParamsSchema = import_v4.z.object({
  _meta: import_v4.z.optional(import_v4.z.object({}).passthrough())
}).passthrough();
...
var ServerCapabilitiesSchema = import_v4.z.object({
  experimental: import_v4.z.optional(import_v4.z.object({}).passthrough()),
  logging: import_v4.z.optional(import_v4.z.object({}).passthrough()),
...
var ToolSchema = import_v4.z.object({
  ...
  inputSchema: import_v4.z.object({
    ...
    properties: import_v4.z.optional(import_v4.z.object({}).passthrough())
  }).passthrough()
}).passthrough();
...
var ImageContentSchema = import_v4.z.object({
  ...
  data: import_v4.z.string().base64(),
...
var BlobResourceContentsSchema = ResourceContentsSchema.extend({
  blob: import_v4.z.string().base64()
});
