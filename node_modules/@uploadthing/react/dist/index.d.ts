import { GenerateTypedHelpersOptions, UploadthingComponentProps, UseUploadthingProps, generateReactHelpers$1 as generateReactHelpers } from "./use-uploadthing-Bq4cnNJV.js";
 ...
 * />
 */
declare function UploadButton<TRouter extends FileRouter, TEndpoint extends keyof TRouter>(props: FileRouter extends TRouter ? ErrorMessage<"You forgot to pass the generic"> : UploadButtonProps<TRouter, TEndpoint>): react_jsx_runtime20.JSX.Element;
...
declare function UploadDropzone<TRouter extends FileRouter, TEndpoint extends keyof TRouter>(props: FileRouter extends TRouter ? ErrorMessage<"You forgot to pass the generic"> : UploadDropzoneProps<TRouter, TEndpoint>): react_jsx_runtime14.JSX.Element;
...
declare function useDropzone({
  ...
  rootRef: react15.RefObject<HTMLDivElement | null>;
  isFocused: boolean;
...
declare function Uploader<TRouter extends FileRouter, TEndpoint extends keyof TRouter>(props: FileRouter extends TRouter ? ErrorMessage<"You forgot to pass the generic"> : UploadthingComponentProps<TRouter, TEndpoint>): react_jsx_runtime19.JSX.Element;

//#endregion
//#region src/components/index.d.ts
//# sourceMappingURL=uploader.d.ts.map

declare const generateUploadButton: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadButtonProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime16.JSX.Element;
declare const generateUploadDropzone: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadDropzoneProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime16.JSX.Element;
declare const generateUploader: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadthingComponentProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime16.JSX.Element;
