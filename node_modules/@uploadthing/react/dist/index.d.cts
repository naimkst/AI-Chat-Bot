import { GenerateTypedHelpersOptions, UploadthingComponentProps, UseUploadthingProps, generateReactHelpers } from "./use-uploadthing-IB868Yeg.cjs";
...
declare function UploadDropzone<TRouter extends FileRouter, TEndpoint extends keyof TRouter>(props: FileRouter extends TRouter ? ErrorMessage<"You forgot to pass the generic"> : UploadDropzoneProps<TRouter, TEndpoint>): react_jsx_runtime0.JSX.Element;
...
declare function useDropzone({
  ...
  rootRef: react1.RefObject<HTMLDivElement | null>;
  isFocused: boolean;
...
declare const generateUploadButton: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadButtonProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime2.JSX.Element;
declare const generateUploadDropzone: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadDropzoneProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime2.JSX.Element;
declare const generateUploader: <TRouter extends FileRouter>(opts?: GenerateTypedHelpersOptions) => <TEndpoint extends keyof TRouter>(props: Omit<UploadthingComponentProps<TRouter, TEndpoint>, keyof GenerateTypedHelpersOptions>) => react_jsx_runtime2.JSX.Element;
